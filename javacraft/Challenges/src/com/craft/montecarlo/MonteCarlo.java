...
System.out.println("This program is showing the use of sorting algorithms to check matching sequences."
		+ "\n The probability and the colors of each example output. \n\n ");
System.out.println("probability of drawing 3 marbles of the same color-");		
		...
		System.out.println("10000 trials: " + marbleSimulation(1000)); 
	}
